# Este es nuestro framework de automatización guardado como un archivo Python.
...
# ----------------------------------------------------------------------
# FASE 1: CONFIGURACIÓN CENTRAL (LA "FIXTURE" DE PYTEST)
# ----------------------------------------------------------------------

@pytest.fixture(scope="module")
def data_loader():
    """
    Esta "fixture" de Pytest se ejecuta UNA SOLA VEZ por módulo.
    Carga todos los DataFrames en memoria y los "inyecta" en cada
    una de las funciones de prueba que lo pidan.
    """
